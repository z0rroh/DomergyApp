...
export declare function getDisplayName(ComponentClass: React.ComponentClass | INamed): string;
export declare function isElementOfType<P = {}>(element: any, ComponentClass: React.ComponentClass<P>): element is React.ReactElement<P>;
/**
