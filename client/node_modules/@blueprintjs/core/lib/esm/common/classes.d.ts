...
export declare const UI_TEXT_LARGE: string;
export declare const RUNNING_TEXT: string;
export declare const RUNNING_TEXT_SMALL: string;
...
export declare const CALLOUT_TITLE: string;
...
export declare const DIALOG_HEADER_TITLE: string;
...
export declare const HOTKEY_GROUP: string;
...
export declare const SPINNER_SVG_CONTAINER: string;
