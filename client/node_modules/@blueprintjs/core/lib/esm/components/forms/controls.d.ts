...
export declare class Switch extends React.PureComponent<ISwitchProps> {
    static displayName: string;
    render(): JSX.Element;
}
export interface IRadioProps extends IControlProps {
}
export declare class Radio extends React.PureComponent<IRadioProps> {
    static displayName: string;
    render(): JSX.Element;
}
...
export declare class Checkbox extends React.PureComponent<ICheckboxProps, ICheckboxState> {
    static displayName: string;
    state: ICheckboxState;
    private input;
    render(): JSX.Element;
    componentWillReceiveProps({checked, indeterminate}: ICheckboxProps): void;
