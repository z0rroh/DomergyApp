...
export declare type ToasterPosition = Position.TOP | Position.TOP_LEFT | Position.TOP_RIGHT | Position.BOTTOM | Position.BOTTOM_LEFT | Position.BOTTOM_RIGHT;
...
export declare class Toaster extends AbstractPureComponent<IToasterProps, IToasterState> implements IToaster {
